...
tags:
  - docs
weight: "200"
title: Appendix 1. Recommended Style Guide
date: 2025-12-20T10:57:25.266Z
lastmod: 2026-01-04T15:44:58.670Z
---
> \[!warning] Third-party document\
> This document is a modified version of a third-party document. The original document is NOT affiliated with DigiPen Inst. or related persons. That document has been accessed and copied from https://github.com/Allar/ue5-style-guide .

Style guides are an outline of what assets in-engine should look like, in terms of development.

If you do not already have a consistent style that works for you, it is heavily recommended that you practice using a style guide before leaving DigiPen. **Following the style guide is entirely OPTIONAL. It is a tool; if it hurts more than it helps, do not use it.**
...
<a name="base-asset-name"></a>\ <a name="1.1"></a>
...
<a name="asset-name-modifiers"></a>\ <a name="1.2"></a>

### 1.2 Asset Name Modifiers

When naming an asset, use these tables to determine the prefix and suffix to use with an asset's [Base Asset Name](#base-asset-name).

<a name="anc-common"></a>\ <a name="1.2.1"></a>
...
| Skeletal Mesh      | SK\_   |            |                                            |
| Texture            | T\_    | \_?        | See [Textures](#anc-textures)              |
| Particle System    | PS\_   |            |                                            |
| Widget Blueprint   | WBP\_  |            |                                            |

<a name="anc-animations"></a>\ <a name="1.2.2"></a>
...
<a name="anc-ai"></a>\ <a name="1.2.3"></a>
...
<a name="anc-bp"></a>\ <a name="1.2.4"></a>
...
<a name="anc-materials"></a>\ <a name="1.2.5"></a>
...
<a name="anc-textures"></a>\ <a name="1.2.6"></a>
...
| Texture (Packed)                    | T\_    | \_\*   | See notes below about [packing](#anc-textures-packing). |
| Texture Cube                        | TC\_   |        |                                                         |
| Media Texture                       | MT\_   |        |                                                         |
| Render Target                       | RT\_   |        |                                                         |
...
<a name="anc-textures-packing"></a>\ <a name="1.2.6.1"></a>
...
<a name="anc-misc"></a>\ <a name="1.2.7"></a>
...
<a name="anc-paper2d"></a>\ <a name="1.2.8"></a>
...
<a name="anc-physics"></a>\ <a name="1.2.9"></a>
...
<a name="anc-sounds"></a>\ <a name="1.2.10"></a>
...
<a name="anc-ui"></a>\ <a name="1.2.11"></a>
...
<a name="anc-effects"></a>\ <a name="1.2.12"></a>
...
<a name="2.1"></a>\ <a name="structure-folder-names"><a>
...
<a name="2.2"></a>\ <a name="structure-top-level"><a>
...
<a name="2.3"></a>\ <a name="structure-developers"></a>
...
<a name="2.4"></a>\ <a name="structure-maps"></a>
...
<a name="2.5"></a>\ <a name="structure-core"></a>
...
<a name="2.6"></a>\ <a name="structure-assettypes"></a>
...
<a name="2.7"></a>\ <a name="structure-large-sets"></a>
...
<a name="2.8"></a>\ <a name="structure-material-library"></a>
...
<a name="2.9"></a>\ <a name="structure-no-empty-folders"></a>
...
<a name="3.1"></a>\ <a name="bp-compiling"></a>
...
<a name="3.2"></a>\ <a name="bp-vars"></a>

### 3.2 Variables

The words `variable` and `property` may be used interchangeably.

<a name="3.2.1"></a>\ <a name="bp-var-naming"></a>

#### 3.2.1 Naming

<a name="3.2.1.1"></a>\ <a name="bp-var-naming-nouns"></a>

##### 3.2.1.1 Nouns

All non-boolean variable names must be clear, unambiguous, and descriptive nouns.

<a name="3.2.1.2"></a>\ <a name="bp-var-naming-case"></a>
...
<a name="3.2.1.3"></a>\ <a name="bp-var-bool-prefix"></a>
...
<a name="3.2.1.4"></a>\ <a name="bp-var-bool-names"></a>
...
<a name="3.2.1.5"></a>\ <a name="bp-vars-naming-context"></a>
...
<a name="3.2.1.6"></a>\ <a name="bp-vars-naming-atomic"></a>
...
<a name="3.2.1.7"></a>\ <a name="bp-vars-naming-complex"></a>
...
<a name="3.2.1.8"></a>\ <a name="bp-vars-naming-arrays"></a>
...
<a name="3.2.2"></a>\ <a name="bp-vars-editable"></a>
...
<a name="3.2.2.1"></a>\ <a name="bp-vars-editable-tooltips"></a>

##### 3.2.2.1 Tooltips

All `Editable` variables, including those marked editable just so they can be marked as `Expose On Spawn`, should have a description in their `Tooltip` fields that explains how changing this value affects the behavior of the blueprint.

<a name="3.2.2.2"></a>\ <a name="bp-vars-editable-ranges"></a>
...
<a name="3.2.3"></a>\ <a name="bp-vars-categories"></a>
...
<a name="3.2.4"></a>\ <a name="bp-vars-access"></a>
...
<a name="3.2.4.1"></a>\ <a name="bp-vars-access-private"></a>

##### 3.2.4.1 Private Variables

Unless it is known that a variable should only be accessed within the class it is defined and never a child class, do not mark variables as private. Until variables are able to be marked `protected`, reserve private for when you absolutely know you want to restrict child class usage.

<a name="3.2.5"></a>\ <a name="bp-vars-advanced"></a>
...
<a name="3.2.6"></a>\ <a name="bp-vars-transient"></a>
...
<a name="3.3.1.1"></a>\ <a name="bp-funcs-naming-verbs"></a>
...
<a name="3.3.1.2"></a>\ <a name="bp-funcs-naming-onrep"></a>
...
<a name="3.3.1.3"></a>\ <a name="bp-funcs-naming-bool"></a>
...
<a name="3.3.1.4"></a>\ <a name="bp-funcs-naming-eventhandlers"></a>
...
<a name="3.3.1.5"></a>\ <a name="bp-funcs-naming-rpcs"></a>
...
<a name="3.3.2"></a>\ <a name="bp-funcs-return"></a>
...
<a name="3.3.3"></a>\ <a name="bp-graphs-funcs-node-limit"></a>
...
<a name="3.3.4"></a>\ <a name="bp-graphs-funcs-description"></a>
...
<a name="3.3.5"></a>\ <a name="bp-graphs-funcs-plugin-category"></a>
...
<a name="3.4"></a>\ <a name="bp-graphs"></a>

### 3.4 Blueprint Graphs

This section covers things that apply to all Blueprint graphs.

<a name="3.4.1"></a>\ <a name="bp-graphs-spaghetti"></a>

#### 3.4.1 No Spaghetti

Wires should have clear beginnings and ends. You should never have to mentally untangle wires to make sense of a graph. Many of the following sections are dedicated to reducing spaghetti.

<a name="3.4.2"></a>\ <a name="bp-graphs-align-wires"></a>
...
<a name="3.4.3"></a>\ <a name="bp-graphs-exec-first-class"></a>

#### 3.4.3 White Exec Lines Are Top Priority

If you ever have to decide between straightening a linear white exec line or straightening data lines of some kind, always straighten the white exec line.

<a name="3.4.4"></a>\ <a name="bp-graphs-block-comments"></a>
...
<a name="3.4.5"></a>\ <a name="bp-graphs-cast-error-handling"></a>
...
<a name="3.4.6"></a>\ <a name="bp-graphs-dangling-nodes"></a>
...
<a name="4"></a>\ <a name="Static Meshes"></a>\ <a name="s"></a>

## 4. Static Meshes

This section will focus on Static Mesh assets and their internals.

<a name="4.1"></a>\ <a name="s-uvs"></a>
...
<a name="5"></a>\ <a name="Niagara"></a>\ <a name="ng"></a>

## 5. Niagara

This section will focus on Niagara assets and their internals.

<a name="5.1"></a>\ <a name="ng-rules"></a>
...
<a name="6"></a>\ <a name="Levels"></a>\ <a name="levels"></a>
...
<a name="6.1"></a>\ <a name="levels-no-errors-or-warnings"></a>
...
<a name="6.2"></a>\ <a name="levels-lighting-should-be-built"></a>
...
<a name="6.4.2"></a>\ <a name="levels-mp-rules-demo"></a>
...
<a name="7"></a>\ <a name="textures"></a>

## 7. Textures

This section will focus on Texture assets and their internals.

<a name="7.1"></a>\ <a name="textures-dimensions"></a>
...
<a name="7.2"></a>\ <a name="textures-density"></a>
